...
rdma_max_num_reads="1"
rdma_max_num_sends="1"
rdma_doorbell_batch_size="1"
rdma_pq_batch_size="1"
shed_load="90"
...
python /proj/bg-PG0/kanakia/scripts/parse_ycsb_nova_leveldb.py $nmachines $exp_results_dir > stats_leveldb_10servers_ranges_out_$recordcount
