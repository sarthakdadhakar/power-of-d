...
results="/tmp/results"
recordcount="$1"
exp_results_dir="$home_dir/new-nova-lsm-sr-scatter-power2-$recordcount"
dryrun="$2"
...
python /proj/bg-PG0/kanakia/scripts/parse_ycsb_nova_leveldb.py $nmachines $exp_results_dir > stats_power2_out
