...
function run_bench() {
	...
	result_dir_name="nova-d-$dist-w-$workload-ltc-$number_of_ltcs-stoc-$nstoc-l0-$cc_l0_stop_write_gb-np-$num_memtable_partitions"
...
for cc_l0_stop_write_gb in "10"
do
for nservers in "2" "4" "6" "11"
do
...
for cc_l0_stop_write_gb in "20" "30" "40" "50"
do
for nservers in "11"
do
...
python /proj/bg-PG0/kanakia/scripts/parse_ycsb_nova_leveldb.py 25 $exp_results_dir > scale_out
