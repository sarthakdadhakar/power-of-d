...
results="/tmp/results"
recordcount="$1"
exp_results_dir="$home_dir/new-nova-lsm-sr-ltc-scale-scatter-$recordcount"
dryrun="$2"
...
l0_start_compaction_mb=$((l0_start_compaction_mb/number_of_ltcs))
l0_stop_write_mb=$((l0_stop_write_mb/number_of_ltcs))
nservers=$((number_of_ltcs+10))
run_bench
done
done

python /proj/bg-PG0/kanakia/scripts/parse_ycsb_nova_leveldb.py $nmachines $exp_results_dir > stats_ltc_scale_scatter_out
